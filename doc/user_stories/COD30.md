# User Story description: As a programmer I want to be able to create a puzzle
...
* [link to jira of User Story](https://codelaborative.atlassian.net/browse/COD-30)
