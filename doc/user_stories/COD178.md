# User Story description: As a product owner I want to know in which SDG this product can improve the world in
...
* [link to jira of User Story](https://codelaborative.atlassian.net/browse/COD-178)
