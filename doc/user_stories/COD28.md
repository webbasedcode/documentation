# User Story description: As a programmer I want to see what everyone is typing and where their textcursor is
...
* [link to jira of User Story](https://codelaborative.atlassian.net/browse/COD-28)
