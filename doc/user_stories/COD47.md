# User Story description: As a programmer I want to be able to upload files into my project so it will be easier to start a new project
...
* [link to jira of User Story](https://codelaborative.atlassian.net/browse/COD-47)
