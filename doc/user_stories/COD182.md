# User Story description: As a programmer i want proper syntax hightlighting when writing code


## Info
* Colaborator: [Vincent](https://github.com/webbasedcode/documentation/blob/main/doc/members/Vincent.md) 
* [link to jira of User Story](https://codelaborative.atlassian.net/browse/COD-182)


## Beschrijving 
Add proper syntax highlighting for the text writing component in the frontend, make sure a user gets proper highlighting when typing code.
